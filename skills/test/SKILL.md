...
sqlite3 .pm/tasks.db "INSERT INTO workflow_events (sprint, task_num, event_type, skill_name, phase, session_id) VALUES ('${sprint}', ${taskNum}, 'phase_entered', 'test', 'RED', '$(echo $CLAUDE_SESSION_ID)');"
```
...
sqlite3 .pm/tasks.db "INSERT INTO workflow_events (sprint, task_num, event_type, skill_name, phase, session_id) VALUES ('${sprint}', ${taskNum}, 'phase_entered', 'test', 'GREEN', '$(echo $CLAUDE_SESSION_ID)');"
```

### Frontend Review (after GREEN for frontend tasks)

If the task has `type: frontend`, invoke `/review` on the affected page after reaching GREEN.
...
```bash
sqlite3 .pm/tasks.db "INSERT INTO workflow_events (sprint, task_num, event_type, skill_name, phase, session_id) VALUES ('${sprint}', ${taskNum}, 'phase_entered', 'test', 'REFACTOR', '$(echo $CLAUDE_SESSION_ID)');"
```
...
```bash
sqlite3 .pm/tasks.db "INSERT INTO workflow_events (sprint, task_num, event_type, skill_name, phase, session_id) VALUES ('${sprint}', ${taskNum}, 'phase_entered', 'test', 'AUDIT', '$(echo $CLAUDE_SESSION_ID)');"
```
...
**After subagent audits complete**, run `/health` on changed files. This is **informational only** — findings do not block the workflow.
...
```bash
sqlite3 .pm/tasks.db "INSERT INTO workflow_events (sprint, task_num, event_type, skill_name, phase, session_id) VALUES ('${sprint}', ${taskNum}, 'phase_entered', 'test', 'CODIFY', '$(echo $CLAUDE_SESSION_ID)');"
```
...
```bash
sqlite3 .pm/tasks.db "INSERT INTO workflow_events (sprint, task_num, event_type, skill_name, phase, session_id, metadata) VALUES ('${sprint}', ${taskNum}, 'phase_entered', 'test', 'FIX_AUDIT', '$(echo $CLAUDE_SESSION_ID)', '{\"reason\": \"${auditGrade}\", \"findings\": \"${auditFindings}\"}');"
```
...
```bash
sqlite3 .pm/tasks.db "INSERT INTO workflow_events (sprint, task_num, event_type, skill_name, phase, session_id) VALUES ('${sprint}', ${taskNum}, 'phase_entered', 'test', 'COMMIT', '$(echo $CLAUDE_SESSION_ID)');"
```
...
```bash
sqlite3 .pm/tasks.db "INSERT INTO workflow_events (sprint, task_num, event_type, skill_name, phase, session_id) VALUES ('${sprint}', ${taskNum}, 'phase_entered', 'test', 'REPORT', '$(echo $CLAUDE_SESSION_ID)');"
sqlite3 .pm/tasks.db "INSERT INTO workflow_events (sprint, task_num, event_type, skill_name, phase, metadata) VALUES ('${sprint}', ${taskNum}, 'task_completed', 'test', 'REPORT', '{\"status\": \"completed\"}');"
```
...
**Status**: ACTIVE
**Related Skill**: `plan` (for planning/PM work)
