...
function buildLayers(
  ...
  const result: Layer[] = [];
  const sr = gran === "day" ? 1 : gran === "week" ? 2 : 3;
...
export function DemandChart({
  ...
  return (
    <>
      <div className="flex flex-1 flex-col relative min-h-[180px]">
        <div className="h-6" />
      ...
      {/* Legend */}
      <div className="flex shrink-0 gap-3 border-t border-border px-2 py-1.5">
